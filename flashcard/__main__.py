...
def parseargs():
    ...
    parser.add_argument('--filename', '-i', type=file_maker, default=None,
                        help="load questions from a file, ignoring tables, "
                             "max-int, and operators")
    parser.add_argument('--tables', "-T", type=range_maker, default='0-10',
                        help="list of tables to construct. (eg. '0,1,2,10-12')")
    parser.add_argument("--total", "-N", type=int, default=TOTAL_QUESTIONS,
